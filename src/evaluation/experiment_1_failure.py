"""Immutable six-file failure evidence for Experiment 1."""
...
from .experiment_1_logging import canonical_json_text
...
def _failure_text(
    ...
    reproduction = (
        "python -m src.evaluation.experiment_1_runner --execute-preregistered "
...
def write_failure_artifact(
    *,
    ...
    if description.classification not in FAILURE_CLASSIFICATIONS:
        raise ValueError("unknown Experiment 1 failure classification")
